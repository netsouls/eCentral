...
{
    internal sealed class RijndaelRequest
    {
        ...
        /// <summary>
        /// Dencryption crypto transform
        /// </summary>
        public ICryptoTransform Decryptor { get; private set; }

        /// <summary>
        /// Encryption crypto transform
        /// </summary>
        ...
        /// </remarks>
        public RijndaelRequest(string passPhrase) :
                                        ...
                                        int passwordIterations)
        {
            ...
            if (minSaltLen < MIN_ALLOWED_SALT_LEN)
                this.MinSaltLength = DEFAULT_MIN_SALT_LEN;
            else
                this.MinSaltLength = minSaltLen;

            // Save max salt length; set it to default if invalid value is passed.
            if (maxSaltLen < 0 || maxSaltLen > MAX_ALLOWED_SALT_LEN)
                this.MaxSaltLength = DEFAULT_MAX_SALT_LEN;
            else
                this.MaxSaltLength = maxSaltLen;
