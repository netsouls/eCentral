...
{
    public static partial class SystemPermissionNames
    {
        ...
        public const string ViewBranchOffices = "ViewBranchOffices";
        public const string ManageBranchOffices = "ManageBranchOffices";

        public const string ViewCompanies = "ViewCompanies";
