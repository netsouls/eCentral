...
namespace eCentral.Core.Infrastructure
{
    ...
    { 
		...
		public SiteEngine(EventBroker broker, ContainerConfigurer configurer)
		{
        ...
        private void InitializeContainer(ContainerConfigurer configurer, EventBroker broker, SiteConfig config)
        {
