...
{
    /// <summary>
    /// A class that finds types needed by site by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether site should iterate assemblies in the app domain when loading site types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <returns>True if the assembly should be loaded into.</returns>
