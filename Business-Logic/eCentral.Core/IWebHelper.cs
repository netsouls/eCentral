...
namespace eCentral.Core
{
    ...
    public partial interface IWebHelper
    {
        ...
        /// <param name="forceLowerCase">The url returned is in lower case</param>
        /// <returns>Page name</returns>
        string GetThisPageUrl(bool includeQueryString, bool forceLowerCase = true);
        ...
        string RelativeWebRoot{ get;}

        /// <summary>
        /// Gets absolute web location
        /// </summary>
        /// <returns>Store location</returns>
        Uri AbsoluteWebRoot{ get;}
        ...
        /// </summary>
        void RestartAppDomainAfterInstall();
