...
using eCentral.Core;
using eCentral.Data.Mapping.Localization;
...
namespace eCentral.Data
{
    ...
    /// Object context
    /// </summary>
    public class SiteObjectContext : DbContext, IDbContext
    {
        public SiteObjectContext(string nameOrConnectionString)
        ...
        protected virtual TEntity AttachEntityToContext<TEntity>(TEntity entity) where TEntity : BaseEntity, new()
        {
            ...
            var alreadyAttached = Set<TEntity>().Local.Where(x => x.RowId == entity.RowId).FirstOrDefault();
