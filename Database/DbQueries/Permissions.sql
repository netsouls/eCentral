SELECT * FROM Permissions
 WHERE SystemName IN ('ManageMessageTemplates')
--INSERT INTO Permissions ( Name, SystemName, Category) VALUES ( 'Manage Email Accounts', 'ManageEmailAccounts', 'Configuration')
...
/* INSERT INTO PermissionsInRoles SELECT RowId, 'CDA6FF15-9293-4DE7-A26E-A04EC233BAA4'
  FROM Permissions WHERE SystemName IN ('ManageEmailAccounts')
*/