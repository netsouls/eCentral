SELECT * FROM Permissions
 WHERE SystemName IN ('ManageSettings')
--INSERT INTO Permissions ( Name, SystemName, Category) VALUES ( 'Manage Settings', 'ManageSettings', 'Configuration')
...
/* INSERT INTO PermissionsInRoles SELECT RowId, 'CDA6FF15-9293-4DE7-A26E-A04EC233BAA4'
  FROM Permissions WHERE SystemName IN ('ManageSettings')
*/